...
const popupEditSave = popupEdit.querySelector(".popup_edit_save");
const popupPlusSave = popupPlus.querySelector(".popup_plus_save");
const popupEditClose = popupEdit.querySelector(".popup_edit_close");
const popupPlusClose = popupPlus.querySelector(".popup_plus_close");
const popupPhotoClose = document.querySelector('.popup_close_photo')
